package org.xuenan.limit.aspect;
...
public class LimitInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(org.xuenan.limit.annotation.Limiter)")
    private Object interceptor(ProceedingJoinPoint pjp) {
